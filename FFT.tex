...
\begin{center}
        \begin{subfigure}{.49\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Potentialslicez4.png}
    \end{subfigure}
    %
    \vspace{-10pt}
    %
    \begin{subfigure}{.49\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Potentialslicez9.png}
    \end{subfigure}
    %
     \vspace{-10pt}
    %
    \begin{subfigure}{.49\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Potentialslicez11.png}
    \end{subfigure}
    %
     \vspace{-10pt}
    %
    \begin{subfigure}{.49\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Potentialslicez14.png}
    \end{subfigure}
    %
    \caption{Colormap of the density contract shown at different z slices.}
